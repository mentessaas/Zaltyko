                ...
                <div className="container relative mx-auto px-4">
                    <div className="flex flex-col items-center gap-8 md:flex-row">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="mb-4 text-xl text-white/75">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="space-y-6">
                                        ...
                                        >
                                            ...
                                            {cert.url && (
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="mt-1 inline-block text-xs text-zaltyko-teal hover:underline"
                                                >
                                                    Ver certificado →
                                                </a>
                                            )}
                        ...
                        {/* CTA */}
                        <section className="rounded-2xl border border-zaltyko-indigo/30 bg-zaltyko-navy p-6 text-white shadow-soft">
