...
const statusColors: Record<string, string> = {
    scheduled: "bg-zaltyko-teal/10 text-zaltyko-teal border-zaltyko-teal/25",
    completed: "bg-zaltyko-indigo/10 text-zaltyko-indigo border-zaltyko-indigo/25",
    cancelled: "bg-zaltyko-coral/10 text-zaltyko-coral border-zaltyko-coral/25",
};
                    ...
                    <div key={date} className="space-y-3">
                        ...
                        >
                            ...
                            <div>
                                ...
                                {isToday && (
                                    <span className="text-xs font-medium text-zaltyko-teal">Hoy</span>
                                )}
                            </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 space-y-2">
                                            ...
                                            {session.isPlaceholder && (
                                                <div className="mt-2 rounded-lg bg-zaltyko-coral/10 px-2 py-1 text-xs font-semibold text-zaltyko-coral">
                                                    Sesión no generada automáticamente
                                                </div>
                                            )}
                                        </div>
                                    </div>
