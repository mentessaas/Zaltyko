...
interface ClusterStatsContent extends ClusterContent {
  socialProof: {
    stats: {
          ...
          <div className="mt-12 p-8 rounded-2xl bg-white border border-gray-100 shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {content.socialProof.academies.map((academy, index) => (
                <span
                  key={index}
                  className="px-4 py-2 rounded-full bg-muted text-gray-700 text-sm font-medium"
                >
                  {academy}
                </span>
              ))}
