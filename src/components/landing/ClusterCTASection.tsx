...
function ClusterCTASectionImpl({
  ...
  const labels = {
    es: {
      ...
      subtitle:
        "Ordena gimnastas, clases, cobros y comunicación con una puesta en marcha adaptada a tu academia.",
      primaryCta: "Crear mi academia gratis",
      secondaryCta: "Hablar con un experto",
      trust1: "Sin tarjeta de credito",
      trust2: "Puesta en marcha guiada",
      trust3: "Ayuda en español",
    },
    en: {
      badge: "Start today",
      title: `Transform your ${modalityLabel} academy management`,
      subtitle:
        "Organize athletes, classes, payments and communication with setup adapted to your academy.",
      primaryCta: "Create my academy for free",
      secondaryCta: "Talk to an expert",
      trust1: "No credit card required",
      trust2: "Guided setup",
      trust3: "Help in Spanish",
    },
  };
