            ...
            {analytics.classAttendance.slice(0, 8).map((clazz) => (
              <div key={clazz.id} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="h-2 w-full rounded-full bg-zaltyko-mist/35">
                    <div
              ...
              <div key={day.day} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="h-2 rounded-full bg-zaltyko-mist/35">
                    <div
                      className="h-2 rounded-full bg-zaltyko-teal"
              ...
              {analytics.popularHours.map((hour) => (
                <div key={hour.hour} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="h-2 rounded-full bg-zaltyko-mist/35">
                      <div
                        className="h-2 rounded-full bg-zaltyko-indigo"
            ...
            return (
              <div key={index} className="flex-1">
                <div className="relative">
                  <div
                    className="mx-auto w-full rounded-t bg-zaltyko-teal/80"
