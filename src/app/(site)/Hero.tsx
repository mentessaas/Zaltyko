      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full border border-zaltyko-primary/20 bg-white/50 px-4 py-1.5 text-sm font-medium text-zaltyko-primary backdrop-blur-sm shadow-soft">
            ...
            <p className="mt-6 max-w-2xl text-lg text-zaltyko-text-secondary sm:text-xl leading-relaxed">
              El sistema de dirección para academias de gimnasia. Controla gimnastas, grupos, cobros, horarios y asistencia desde un panel claro.
            </p>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center w-full sm:w-auto">
              <Link
                ...
                className={cn(
                  ...
                  "w-full shadow-soft transition-all duration-150 hover:shadow-medium sm:w-auto"
                )}
              >
          ...
          <div className="relative mx-auto w-full max-w-[500px] lg:max-w-none perspective-1000">
            {/* Main Glass Card */}
            <div className="relative z-10 rounded-2xl border border-zaltyko-mist/70 bg-white p-6 shadow-soft transition-transform duration-150 hover:scale-[1.01] md:p-8">
            ...
            {/* Floating Elements */}
            <div className="absolute -right-12 -top-12 z-0 hidden rounded-2xl border border-zaltyko-mist/70 bg-white p-4 shadow-soft md:block">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-zaltyko-coral/12 text-zaltyko-coral">
            ...
            <div className="absolute -bottom-8 -left-8 z-20 hidden rounded-2xl border border-zaltyko-mist/70 bg-white p-4 shadow-soft md:block">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-zaltyko-teal/12 text-zaltyko-teal">
