const steps = [
  {
    ...
    description:
      "Registra tu academia, define si trabajas artística femenina, artística masculina, rítmica o mixta artística/rítmica, y configura tu ubicación.",
  },
  {
  ...
  {
    title: "Sube gimnastas y empieza a operar",
    description:
      "Importa gimnastas desde Excel o créalas manualmente. La asistencia está disponible desde el primer día.",
  },
];
    ...
    <section id="modulos" className="py-20">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 sm:px-6 lg:flex-row lg:px-8">
        <div className="flex-1">
          ...
          <p className="mt-4 font-sans text-base text-muted-foreground">
            Datos separados por academia, roles claros y controles de acceso para trabajar con menores, familias y equipo técnico con confianza.
          </p>
        </div>
