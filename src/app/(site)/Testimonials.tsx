...
const testimonials: Testimonial[] = [
  ...
  },
  {
    name: "Julián Andrade",
    rating: 5,
    text: "Migramos 180 gimnastas sin fricción. <span class='font-bold text-zaltyko-accent-light'>La puesta en marcha dejó grupos, cobros y familias ordenados.</span> Flujo limpio y profesional.",
  ...
  },
  {
    ...
    avatar: {
      ...
      initialsBg: "from-zaltyko-indigo/20 to-zaltyko-teal/25",
    },
  },
];
              ...
              <div className="flex-grow">
                <div className="mb-4 flex gap-1">
                  {[...Array(testimonial.rating)].map((_, index) => (
                    <Star
                      key={index}
                      className="h-4 w-4 fill-zaltyko-teal text-zaltyko-teal"
                    />
                  ))}
                </div>
