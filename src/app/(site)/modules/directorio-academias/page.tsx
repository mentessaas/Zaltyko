...
export const metadata: Metadata = {
  ...
  description: "Aumenta la visibilidad de tu academia de gimnasia artística o rítmica con un perfil público optimizado.",
  keywords: [
    "directorio gimnasia",
    "academias por ciudad",
    "visibilidad academias gimnasia",
  ...
  openGraph: {
    title: "Directorio de Academias de Gimnasia",
    description: "Aumenta la visibilidad de tu academia de gimnasia con un perfil público optimizado. Capta nuevas familias interesadas.",
    type: "website",
  },
};
...
El boca a boca sigue funcionando, pero depender exclusivamente de él limita tu crecimiento. Las academias que combinan recomendaciones personales con visibilidad online captan más familias interesadas cada temporada.`;
...
Personaliza tu perfil con logo, fotos de instalaciones, descripción de tu proyecto educativo y las modalidades que ofreces: artística femenina, artística masculina, rítmica o mixta artística/rítmica. Muestra tus horarios, rangos de edad atendidos, niveles disponibles y datos de contacto. Los interesados pueden enviarte consultas directamente desde tu perfil.
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            operatingSystem: "Web",
            description: "Directorio público de academias de gimnasia artística y rítmica. Aumenta tu visibilidad online y capta nuevas familias.",
      ...
      <ModuleHero
        ...
        subtitle="Aumenta la visibilidad de tu academia con un perfil profesional en el directorio de academias de gimnasia artística y rítmica."
        color={MODULE_COLOR}
      />

      <ProblemSection
        title="La dificultad de captar nuevas familias sin presencia online"
