...
export const metadata: Metadata = {
  ...
  description: "Visualiza métricas clave de tu academia de gimnasia. Panel de dirección con informes de asistencia, cobros y ocupación.",
  keywords: [
    "informes gimnasia",
    "métricas gimnasia",
    "analytics clubes",
    "panel academia gimnasia",
    "métricas academia gimnasia",
    "análisis rendimiento club",
  ],
  openGraph: {
    title: "Dashboard y Reportes Deportivos",
    description: "Visualiza métricas clave de tu academia de gimnasia. Panel con informes y análisis financiero.",
    type: "website",
  },
};
...
const solutionContent = `El panel de Zaltyko centraliza todas las métricas importantes de tu academia en una vista visual accesible desde cualquier dispositivo. Nada más entrar ves los indicadores clave: total de gimnastas activas, asistencia del mes, ingresos recaudados, morosidad pendiente y tendencias respecto al período anterior. Información actualizada sin compilar nada manualmente.
...
const useCases = [
  {
    ...
    description: "Consulta métricas de asistencia de tus gimnastas, identifica quiénes faltan con frecuencia y ajusta la planificación de entrenamientos según la asistencia real de cada sesión.",
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            operatingSystem: "Web",
            description: "Panel e informes para academias de gimnasia. Métricas y análisis financiero claro.",
