...
export const metadata: Metadata = {
  title: "Gestión de Gimnastas para Gimnasia",
  description: "Centraliza fichas de gimnastas, niveles técnicos y progresiones. Software especializado para academias de gimnasia artística y rítmica.",
  keywords: [
    "software gestión de gimnastas",
    "niveles de gimnasia",
  ...
  openGraph: {
    title: "Gestión de Gimnastas para Gimnasia",
    description: "Centraliza fichas de gimnastas, niveles técnicos y progresiones. Software especializado para academias de gimnasia.",
    type: "website",
  },
};
...
const solutionContent = `Zaltyko transforma la gestión de gimnastas en un proceso fluido y profesional. Nuestro módulo de fichas centraliza toda la información relevante de cada gimnasta en un perfil digital completo y siempre actualizado. Desde datos de contacto de emergencia hasta niveles técnicos por aparato o rutina, todo está a un clic de distancia para entrenadores y administrativos autorizados.

El sistema de seguimiento de progresiones te permite registrar los niveles técnicos de cada gimnasta en gimnasia artística o rítmica. Los entrenadores pueden actualizar evaluaciones después de cada sesión, creando un historial detallado que facilita la planificación del entrenamiento personalizado y la comunicación con las familias sobre el desarrollo deportivo de sus hijos.
...
const useCases = [
  {
    ...
    description: "Accede rápidamente a las fichas de tus gimnastas antes de cada sesión. Consulta su nivel técnico actual, condiciones médicas a considerar y notas de entrenamientos anteriores para personalizar tu plan de trabajo.",
  },
  {
...
export default function GestionAtletasPage() {
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Zaltyko - Gestión de Gimnastas",
            applicationCategory: "BusinessApplication",
            operatingSystem: "Web",
            description: "Módulo de gestión de gimnastas para academias de gimnasia. Centraliza fichas, niveles técnicos y documentación.",
      ...
      <ProblemSection
        title="El caos de gestionar información de gimnastas sin sistema"
