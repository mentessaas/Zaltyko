...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Muchas academias pueden avanzar en una primera sesión guiada. Importamos la base principal, configuramos grupos, horarios y cobros, y definimos aparte el alcance de cualquier migración histórica.",
  },
  {
    question: "¿Mis datos están aislados de otras academias?",
    answer:
      "Zaltyko aplica aislamiento por academia, controles de acceso por rol y conexiones cifradas. El acceso real depende de la relación de cada usuario con la academia; la información legal y las solicitudes de derechos se rigen por la política de privacidad vigente.",
  },
  {
    question: "¿Puedo migrar mis datos desde Excel o Google Sheets?",
    answer:
      "Sí. Puedes importar la base principal desde CSV o Excel. Para grupos, familias, cobros o históricos complejos, revisamos primero el formato y acordamos una puesta en marcha acompañada.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Puedes solicitar exportaciones según los módulos disponibles y la política de salida. La retención y eliminación posterior a la cancelación se aplican conforme a la política de privacidad y conservación vigente.",
  },
  {
