...
export const ACADEMY_TYPES = [
  { value: "artistica", label: "Gimnasia artística femenina/masculina" },
...
export const onboardingCopy: Record<AcademyType, { steps: StepMap }> = {
  artistica: {
    steps: buildCopy({
      ...
      description: [
        ...
        "Detalla los datos básicos de la academia. Podrás completar el resto desde tu panel de control.",
      ],
      sectionTitle: [
      ...
      sectionDescription: [
        ...
        "Indica el nombre comercial, ubicación y disciplina principal. Podrás añadir entrenadores, gimnastas y configurar cobros desde tu panel.",
      ],
      recommendations: [
        [
        ...
        [
          ...
          "Selecciona artística para personalizar aparatos, niveles y seguimiento técnico.",
          "Después de crear tu academia, verás una guía de puesta en marcha para completar la configuración.",
        ],
      ],
    }),
  },
  ritmica: {
    steps: buildCopy({
      ...
      description: [
        ...
        "Completa la información básica de la academia. Podrás añadir entrenadoras, gimnastas y configurar cobros desde tu panel.",
      ],
      sectionTitle: [
        "Cuenta principal",
      ...
      sectionDescription: [
        ...
        "Tu información alimentará informes, estadísticas y comunicación externa. Podrás completar el resto desde el panel.",
      ],
      recommendations: [
        [
  ...
  general: {
    steps: buildCopy({
      heading: [
        "Paso 1 · Crea la cuenta responsable de tu academia mixta",
        "Paso 2 · Presenta tu academia artística/rítmica",
      ],
      description: [
        "Configura el acceso principal para gestionar artística y rítmica desde una misma academia.",
        "Completa los datos básicos de la academia. Podrás añadir entrenadores, gimnastas, grupos y cobros desde tu panel.",
      ],
      sectionTitle: [
        "Cuenta principal",
      ...
      sectionDescription: [
        ...
        "Estos datos aparecerán en comunicaciones e informes internos. Podrás completar el resto desde el panel.",
      ],
      recommendations: [
        [
        ...
        [
          "Incluye el nombre como aparece en tu material promocional.",
          "Añade ciudad para activar reportes locales (opcional).",
          "Usa mixta solo si trabajas artística y rítmica en la misma academia.",
          "Después de crear tu academia, verás una guía de puesta en marcha para completar la configuración.",
        ],
      ],
    }),
