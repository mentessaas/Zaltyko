    ...
    articles: [
      {
        ...
        steps: ["Abre Facturación.", "Revisa conceptos activos.", "Añade importes y periodicidad.", "Comprueba el resumen antes de cobrar."],
      },
      {
        slug: "procesar-pagos",
      ...
      },
      {
        ...
        steps: ["Abre el panel de facturación.", "Filtra pagos vencidos.", "Revisa el historial.", "Contacta a la familia por el canal acordado."],
      },
    ],
  },
];
