...
export const PRODUCT_PLANS: ProductPlan[] = [
  {
    ...
    priceEurCents: 0,
    description: "Para academias pequeñas que quieren ordenar grupos, asistencia y cobros básicos.",
    shortDescription: "Hasta 50 gimnastas · 1 academia",
    athleteLimit: 50,
    groupLimit: 3,
    classLimit: 10,
    academyLimit: 1,
  ...
  },
  {
    ...
    internalName: "Growth",
    priceEurCents: 1900,
    description: "Para academias en crecimiento que necesitan más capacidad, cobros y seguimiento diario.",
