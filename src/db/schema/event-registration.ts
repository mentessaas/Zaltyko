...
export const eventRegistrations = pgTable(
  ...
  (table) => ({
    tenantIdx: index("event_registrations_tenant_idx").on(table.tenantId),
...
export const eventWaitlist = pgTable(
  ...
  (table) => ({
    tenantIdx: index("event_waitlist_tenant_idx").on(table.tenantId),
...
export const eventCategories = pgTable(
  ...
  (table) => ({
    tenantIdx: index("event_categories_tenant_idx").on(table.tenantId),
...
export const eventPayments = pgTable(
  ...
  (table) => ({
    tenantIdx: index("event_payments_tenant_idx").on(table.tenantId),
