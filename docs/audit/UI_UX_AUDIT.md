...
| UI-004 | navegación limitada vs API | La navegación por rol y los estados denegados core quedaron cubiertos por role smoke; no se declara cobertura exhaustiva de todos los 292 handlers. | Media | Un estado denegado no cubierto puede confundir a familias y coaches. | Mantener matriz de rutas/API y ampliar smoke en cada módulo transaccional. | Terra |
