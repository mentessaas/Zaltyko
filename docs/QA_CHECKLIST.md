...
| `pnpm test:e2e:auth` equivalente con `.env.local` | PENDIENTE | Debe iniciar sesión con cuentas E2E existentes y regenerar sus storage states; aprovisionar exige la puerta explícita `E2E_ALLOW_PROVISIONING=true`. |
