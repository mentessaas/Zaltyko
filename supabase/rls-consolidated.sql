...
-- ============================================================================
-- EVENT REGISTRATION TABLES (Tenant-scoped)
-- ============================================================================
...
DROP POLICY IF EXISTS "event_registrations_modify" ON event_registrations;
CREATE POLICY "event_registrations_modify" ON event_registrations
  FOR ALL USING (
    is_admin() OR tenant_id = get_current_tenant()
  ) WITH CHECK (
    is_admin() OR tenant_id = get_current_tenant()
...
DROP POLICY IF EXISTS "event_waitlist_modify" ON event_waitlist;
CREATE POLICY "event_waitlist_modify" ON event_waitlist
  FOR ALL USING (
    is_admin() OR tenant_id = get_current_tenant()
  ) WITH CHECK (
    is_admin() OR tenant_id = get_current_tenant()
...
DROP POLICY IF EXISTS "event_categories_modify" ON event_categories;
CREATE POLICY "event_categories_modify" ON event_categories
  FOR ALL USING (
    is_admin() OR tenant_id = get_current_tenant()
  ) WITH CHECK (
    is_admin() OR tenant_id = get_current_tenant()
...
CREATE POLICY "event_payments_select" ON event_payments
  FOR SELECT USING (
    is_admin() OR tenant_id = get_current_tenant()
  );

DROP POLICY IF EXISTS "event_payments_modify" ON event_payments;
CREATE POLICY "event_payments_modify" ON event_payments
  FOR ALL USING (
    is_admin() OR tenant_id = get_current_tenant()
  ) WITH CHECK (
    is_admin() OR tenant_id = get_current_tenant()
...
DROP POLICY IF EXISTS "athlete_invitations_owner_read" ON athlete_invitations;
CREATE POLICY "athlete_invitations_owner_read" ON athlete_invitations
  FOR SELECT
  USING (
    EXISTS (
      SELECT 1
...
DROP POLICY IF EXISTS "athlete_invitations_owner_modify" ON athlete_invitations;
CREATE POLICY "athlete_invitations_owner_modify" ON athlete_invitations
  FOR ALL
  USING (
    EXISTS (
      SELECT 1
